...
results = client.query("SELECT
  THREAD_ID AS STATEMENTS_THREAD_ID, EVENT_NAME AS STATEMENTS_EVENT_NAME, DIGEST, DIGEST_TEXT,
...
results = client.query("SELECT
  THREAD_ID AS WAITS_THREAD_ID, EVENT_NAME AS WAITS_EVENT_NAME, TIMER_WAIT AS WAITS_TIMER_WAIT, SPINS,
